...
<Collapsible summary="Using zoom transition with Link.Preview">
...
<Collapsible summary={<><CODE>usePreventZoomTransitionDismissal</CODE> cannot be used in screens with modal presentation</>}>
